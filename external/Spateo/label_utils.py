"""
Label utilities for adding colors and labels to PyVista models.

This module is adapted from Spateo's tdr.models.utilities.label_utils.
"""
...
def add_model_labels(
    ...
    inplace: bool = False,
) -> Tuple[Optional[Union[PolyData, UnstructuredGrid]], Optional[Union[str]]]:
    """
